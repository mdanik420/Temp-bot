...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Anik vai") || (event.body.toLowerCase() == "অনিক ভাই") || (event.body.toLowerCase() == "অনিক") || (event.body.toLowerCase() == "Anik")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞𝐌𝐎𝐇𝐀𝐌𝐌𝐀𝐃 𝐀𝐍𝐈𝐊 (✷‿✷)☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐓𝐎𝐌.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/ayuacah.nurzaehan\nতার সাতে যোগা যোগ করবেন WhatsApp :- +8801815397046", threadID);
   };

   if ((event.body.toLowerCase() == "tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:𝐌𝐎𝐇𝐀𝐌𝐌𝐀𝐃 𝐀𝐍𝐈𝐊  ❤️/n হাই আমি মেছেন্জার ROBOT  আামার বস অনিক আমাকে আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য/n আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "adbmin") || (event.body.toLowerCase() == "bolr admin")) {
     return api.sendMessage("He is 𝐌𝐎𝐇𝐀𝐌𝐌𝐀𝐃 𝐀𝐍𝐈𝐊  ❤️/n তাকে সবাই 𝐓𝐎𝐌(✷‿✷)নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "salam ")) {
   ...
   if ((event.body.toLowerCase() == "Jesmin") || (event.body.toLowerCase() == "জেসমিন")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস অনিক এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে অনিক এর ইনবক্সে চলে যা পাগল ছাগল🌚🐸🌶️🍆", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("হুম আমার বস ANIK ও তেমাকে ভালোবাসে🥰🥱", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami anik") || (event.body.toLowerCase() == "kire")) {
     return api.sendMessage("হ্যাঁ অনিক কলিজা ভালো আছো?", threadID);
   };
   mess = "{name}"
