...
module.exports.onLoad = async () => {
  ...
  const _0x7a9f3a = _0x3f2f66(__dirname, "cache/canvas", "romedate.jpeg");
...
async function makeImage({
  ...
  let _0x282aa1 = await _0x5e3560.read(_0x1b6a7b + '/romedate.jpeg');
  ...
  _0x282aa1.composite(_0x25c0ea.resize(0xf0, 0xe4), 0x250, 0x80).composite(_0x279174.resize(0xeb, 0xeb), 0x38c, 0x4d);
